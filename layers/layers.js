...
lyr_GoogleSatelit_0.setVisible(true);lyr_ADMINISTRASIDESA_AR_25K_1.setVisible(true);lyr_PENDIDIKAN_PT_25K_2.setVisible(true);
var layersList = [lyr_GoogleSatelit_0,lyr_ADMINISTRASIDESA_AR_25K_1,lyr_PENDIDIKAN_PT_25K_2];
...
lyr_PENDIDIKAN_PT_25K_2.set('fieldLabels', {'NAMOBJ': 'no label', 'LUAS': 'no label', 'KATPDK': 'no label', 'JLPDDK': 'no label', 'FGGPDK': 'no label', 'REMARK': 'no label', 'FCODE': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'JJGPDF': 'no label', 'JNSPDL': 'no label', });
lyr_PENDIDIKAN_PT_25K_2.on('precompose', function(evt) {
